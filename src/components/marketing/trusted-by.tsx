...
const logoSets: Logo[][] = [
  [
    ...
    },
    {
      ...
      mark: (
        <MarkFrame>
          <rect fill="#F25022" height="8" width="8" x="3" y="3" />
          <rect fill="#7FBA00" height="8" width="8" x="13" y="3" />
          <rect fill="#00A4EF" height="8" width="8" x="3" y="13" />
          <rect fill="#FFB900" height="8" width="8" x="13" y="13" />
        </MarkFrame>
      ),
    },
    {
      ...
      mark: (
        <MarkFrame>
          <g fill="none" stroke="#0D0D0D" strokeWidth="1.65">
  ...
  [
    ...
    },
    {
      ...
      mark: (
        <MarkFrame>
          <defs>
            <linearGradient id="linear-mark-gradient" x1="3.5" x2="19" y1="3.5" y2="19">
              <stop offset="0" stopColor="#28283C" />
